...
ext_modules = [
    Extension(
        "pymt_prms_groundwater.lib.prmsgroundwater",
        ["pymt_prms_groundwater/lib/prmsgroundwater.pyx"],
        libraries=libraries + ["bmiprmsgroundwater"],
        extra_objects=["pymt_prms_groundwater/lib/bmi_interoperability.o"],
        **common_flags
    ),
]
...
entry_points = {
    "pymt.plugins": [
        "PRMSGroundwater=pymt_prms_groundwater.bmi:PRMSGroundwater",
    ]
}
...
class build_ext(_build_ext):
    def run(self):
        with as_cwd("pymt_prms_groundwater/lib"):
...
setup(
    ...
    description="PyMT plugin for pymt_prms_groundwater",
    long_description=long_description,
    version="0.2.0",
    url="https://github.com/pymt-lab/pymt_prms_groundwater",
    classifiers=[
